package com.oddie.web3.contract;
 ...
 * on the Polygon chain. Players contract version 1.5
 * Polygon Mainnet contract address: 0xF405Fb60690395D8d4d047Cc8916Df256270285f
 * Polygon Mainnet contract block explorer:
...
public class PolygonPlayers extends Contract {
  ...
  @Deprecated
  protected PolygonPlayers(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice,
      BigInteger gasLimit) {
    super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
  }

  protected PolygonPlayers(String contractAddress, Web3j web3j, Credentials credentials,
      ContractGasProvider contractGasProvider) {
    super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
  }

  @Deprecated
  protected PolygonPlayers(String contractAddress, Web3j web3j, TransactionManager transactionManager,
  ...
  public List<PlayerPrimaryWalletSetEventResponse> getPlayerPrimaryWalletSetEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(PLAYERPRIMARYWALLETSET_EVENT,
        transactionReceipt);
    ArrayList<PlayerPrimaryWalletSetEventResponse> responses = new ArrayList<PlayerPrimaryWalletSetEventResponse>(
        valueList.size());
  ...
  public Flowable<PlayerPrimaryWalletSetEventResponse> playerPrimaryWalletSetEventFlowable(
  ...
  public List<PlayerSecondaryWalletRemovedEventResponse> getPlayerSecondaryWalletRemovedEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(PLAYERSECONDARYWALLETREMOVED_EVENT,
        transactionReceipt);
    ArrayList<PlayerSecondaryWalletRemovedEventResponse> responses = new ArrayList<PlayerSecondaryWalletRemovedEventResponse>(
        valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public Flowable<PlayerSecondaryWalletRemovedEventResponse> playerSecondaryWalletRemovedEventFlowable(
      EthFilter filter) {
    return web3j.ethLogFlowable(filter).map(new Function<Log, PlayerSecondaryWalletRemovedEventResponse>() {
      ...
      public PlayerSecondaryWalletRemovedEventResponse apply(Log log) {
        Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(PLAYERSECONDARYWALLETREMOVED_EVENT,
            log);
        PlayerSecondaryWalletRemovedEventResponse typedResponse = new PlayerSecondaryWalletRemovedEventResponse();
        typedResponse.log = log;
        typedResponse.playerUUIDIndex = (byte[]) eventValues.getIndexedValues().get(0).getValue();
  ...
  public List<PlayerSecondaryWalletSetEventResponse> getPlayerSecondaryWalletSetEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(PLAYERSECONDARYWALLETSET_EVENT,
        transactionReceipt);
    ArrayList<PlayerSecondaryWalletSetEventResponse> responses = new ArrayList<PlayerSecondaryWalletSetEventResponse>(
        valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public Flowable<PlayerSecondaryWalletSetEventResponse> playerSecondaryWalletSetEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public List<PlayerStateDataRemovedEventResponse> getPlayerStateDataRemovedEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(PLAYERSTATEDATAREMOVED_EVENT,
        transactionReceipt);
    ArrayList<PlayerStateDataRemovedEventResponse> responses = new ArrayList<PlayerStateDataRemovedEventResponse>(
        valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public Flowable<PlayerStateDataRemovedEventResponse> playerStateDataRemovedEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public List<PlayerStateDataSetEventResponse> getPlayerStateDataSetEvents(TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(PLAYERSTATEDATASET_EVENT,
        transactionReceipt);
    ArrayList<PlayerStateDataSetEventResponse> responses = new ArrayList<PlayerStateDataSetEventResponse>(
        valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public Flowable<PlayerStateDataSetEventResponse> playerStateDataSetEventFlowable(DefaultBlockParameter startBlock,
  ...
  public RemoteFunctionCall<String> getPlayerStateData(String _playerUUID, String _setterAddress,
  ...
  public RemoteFunctionCall<List> getPlayerStateDataBatch(List<String> _playerUUIDs, String _setterAddress,
      Boolean includeGateway) {
  ...
  public RemoteFunctionCall<TransactionReceipt> setPlayerStateDataBatch(List<String> _playerUUIDs,
      List<String> _ipfsHashes) {
    List<String> _playerUUIDsFixed = new ArrayList<>();
    for (String s : _playerUUIDs) {
      _playerUUIDsFixed.add(s.replace("-", ""));
    }
  ...
  @Deprecated
  public static PolygonPlayers load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice,
      BigInteger gasLimit) {
    return new PolygonPlayers(contractAddress, web3j, credentials, gasPrice, gasLimit);
  }

  @Deprecated
  public static PolygonPlayers load(String contractAddress, Web3j web3j, TransactionManager transactionManager,
      BigInteger gasPrice, BigInteger gasLimit) {
    return new PolygonPlayers(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
  }

  public static PolygonPlayers load(String contractAddress, Web3j web3j, Credentials credentials,
      ContractGasProvider contractGasProvider) {
